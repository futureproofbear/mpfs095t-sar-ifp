...
## ---------------- (Discovery: no SD/eMMC demux) ----------------
## The Icicle board had a TS3A27518E demux (SDIO_SW_SEL0/1/EN_N) to share the SDMMC
## controller between eMMC and SD; the Discovery Kit wires the microSD directly to the
## MSS SDIO pads (SD -> MSSIO_B4), so those three fabric tie-off ports are removed here.
